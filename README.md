...
Проект "MatrixClock" на базе ESP32, который использует светодиодную матрицу 64x32 для отображения времени, температуры, давления и влажности. 
Проект также поддерживает подключение к Wi-Fi, синхронизацию времени через NTP, управление яркостью экрана и отправку данных на народный мониторинг (narodmon.ru).
